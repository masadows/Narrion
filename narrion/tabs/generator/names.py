...
class NameWidget(QWidget):
    def __init__(self):
        ...
        self.grid.addWidget(QLabel("Type:"), 4, 1)
        self.grid.addWidget(QLabel("Sex:"), 4, 4)
        ...
        self.grid.addWidget(name_type_select, 5, 0, 1, 3)
