from PySide6.QtWidgets import (
    QMainWindow, QWidget, QVBoxLayout, QTabWidget, QToolBar, QLabel,
    QLineEdit, QComboBox, QStatusBar, QCheckBox, QDockWidget, 
)
...
class MainWindow(QMainWindow):
    ...
    def _create_toolbar(self) -> QToolBar:
        ...
        act_dice = QAction(QIcon("images/icones/dice.png"), "Rzut kośćmi", self)
    ...
    def toggle_light_dark(self, state):
        ...
        if "Dark" in name_parts:
            ...
            new_name = self.current_theme.replace("Light", "Dark") if "Light" in name_parts else self.current_theme + " Dark"
    ...
    def open_initiative_dock(self):
        if self.initiative_dock is None:
            ...
            self.initiative_dock.setFeatures(QDockWidget.DockWidgetClosable | QDockWidget.DockWidgetMovable | QDockWidget.DockWidgetFloatable)
    ...
    def open_dice_dock(self):
        if self.dice_dock is None:
            ...
            self.dice_dock.setFeatures(QDockWidget.DockWidgetClosable | QDockWidget.DockWidgetMovable | QDockWidget.DockWidgetFloatable)
